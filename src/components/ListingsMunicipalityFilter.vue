<template>
    <div class="form-grid">
        <div class="label">Zamknout
            <Tooltip
                     tip="Při zamčení nebude výčet měst ovlivňován dalšími změnami filtru. Počet měst se zamkne a při změně filtru nebudou aktualizovány." />
        </div>
...
export default defineComponent({
    name: "ListingsMunicipalityFilter",
    components: {
        Tooltip
    },
    props: {
